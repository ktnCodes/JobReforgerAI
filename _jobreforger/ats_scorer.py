...
_DOMAIN_KEYWORD_FILES = {
    ...
    'embedded': 'keywords_embedded.json',
...
DOMAIN_PATTERNS = {
    ...
    'embedded': {
        'keywords': ['embedded', 'firmware', 'rtos', 'microcontroller', 'mcu', 'arm',
                    'cortex', 'device driver', 'bsp', 'bootloader', 'can bus', 'spi',
                    'i2c', 'uart', 'gpio', 'jtag', 'fpga', 'real-time', 'yocto',
                    'precision agriculture', 'autonomous', 'gnss', 'sensor fusion',
                    'isobus', 'j1939', 'hil', 'misra', 'functional safety'],
        'weight': 1.0
    }
}
...
DOMAIN_PROTOTYPES = {
    ...
    'embedded': [
        "Embedded software engineering, firmware development, RTOS, device drivers, and BSP",
        "C/C++ programming, ARM Cortex-M microcontrollers, real-time Linux, and Yocto",
        "CAN bus, J1939, ISOBUS, SPI, I2C, UART, and serial communication protocols",
        "Precision agriculture, autonomous vehicles, GNSS/RTK, sensor fusion, and guidance systems",
        "Functional safety, ISO 26262, MISRA C, HIL testing, and embedded systems quality",
    ]
}
