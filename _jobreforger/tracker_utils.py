...
def add_application(
    ...
    new_row = {
        ...
        'ATS Score': f"{ats_score:.1f}%" if ats_score is not None else "",
        'HR Score': f"{hr_score:.1f}%" if hr_score is not None else "",
        'Notes': notes,
        'Interview Date': '',
        'Follow Up Date': '',
        'Response': ''
...
def update_application_status(company: str, job_title: str, status: str, notes: Optional[str] = None):
    """
