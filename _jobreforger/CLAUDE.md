...
## Dual Scoring System (v2.5 Rebalanced)

### ATS Scorer (Semantic + Keyword Matching)
Advanced resume-to-job-description analysis with eight weighted components:

| Metric | Weight | Description |
|--------|--------|-------------|
| Phrase Match | 25% | Multi-word industry phrase detection (exact phrases = 10.6x callbacks) |
| Keyword Match | 20% | Lemmatized keywords with synonym expansion |
| Weighted Industry Terms | 15% | Domain-specific terminology with decay |
| Semantic Similarity | 10% | Sentence Transformers vector matching |
| BM25 Score | 10% | Probabilistic relevance ranking |
| Job Title Match | 10% | Exact JD title in resume header/summary |
| Graph Centrality | 5% | NetworkX skill inference bonus |
