---
name: jobreforger-resume
description: "Generate a tailored resume + cover letter for a job application. Triple-scorer swarm (ATS + HR + LLM). Target: 75-85% ATS, 70%+ HR. Trigger on: 'apply to this job', 'full package', or any pasted job description."
argument-hint: "[paste job description]"
---
