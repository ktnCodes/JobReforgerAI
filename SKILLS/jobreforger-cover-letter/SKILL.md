---
name: jobreforger-cover-letter
description: "Write a one-page cover letter for a job application. Matches to existing tailored resume if available. 350-400 words, DOCX output. Trigger on: 'write a cover letter', 'cover letter only'."
