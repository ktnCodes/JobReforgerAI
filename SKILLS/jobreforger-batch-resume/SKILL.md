---
name: jobreforger-batch-resume
description: "Process multiple job descriptions simultaneously using parallel agents. Each agent generates a full application package (resume + cover letter + DOCX). Add .txt files to batch_jds/ folder first."
argument-hint: ""
---
