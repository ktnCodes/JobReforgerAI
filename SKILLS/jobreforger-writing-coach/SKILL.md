---
name: jobreforger-writing-coach
description: "Analyze and enhance resume writing quality. 8-dimension audit + before/after rewrites. Scores verb power, impact density, STAR completeness, and more. Trigger on: 'improve my resume', 'writing coach', 'make bullets stronger'."
argument-hint: "[resume file path or paste resume text]"
---

# Resume Writing Coach — Advanced Writing Enhancement

Analyze and enhance the writing quality of a resume. Can be used standalone to improve an existing resume, or is automatically integrated into `/jobreforger-resume` and `/jobreforger-tailor-resume` commands.
...
### Mode B: Integrated (called internally during /jobreforger-resume or /jobreforger-tailor-resume)
...
- The parent command handles scoring and output

---

## INTEGRATION PROTOCOL

When this skill is activated during `/jobreforger-resume` or `/jobreforger-tailor-resume`, it applies at Phase 2 (Resume Generation) as follows:
