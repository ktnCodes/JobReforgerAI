---
name: jobreforger-tailor-resume
description: "Tailor a resume for a specific job — ATS + HR optimized, Swarm v3.0. Target: 75-85% ATS, 70%+ HR. Resume only, no cover letter. Trigger on: 'tailor my resume', 'resume only', 'ATS optimize'."
