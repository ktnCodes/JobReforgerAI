---
name: jobreforger-find-jobs
description: "Search live job boards for roles matching your resume, scored and ranked by ATS + HR fit. Uses discover_jobs MCP tool. Trigger on: 'find jobs', 'search for jobs', 'what jobs match my resume'."
...
Option 1 — Cloud (easiest, no setup):
  ...
  Then run /jobreforger-setup to link your account.
...
What would you like to do next?
  ...
  A) Tailor my resume for job #1 → /jobreforger-tailor-resume [paste JD]
  B) Generate a cover letter    → /jobreforger-cover-letter [paste JD]
